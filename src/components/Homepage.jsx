      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div className="d-flex ms-2">
              {firebase.isLoggedIn ? (
                <div>
                  <button className="btn btn-primary me-2" onClick={() => firebase.logout()}>
                    Logout
                  </button>
                <Link to='/addlisting'>
                  <button className="btn btn-danger ms-4">Add Listing</button>
                  </Link>
                </div>
              ) : (
                <div>
                  <Link to="/login">
                    <button className="btn btn-primary me-2 ms-3">Login</button>
                  </Link>
                  <Link to="/register">
